...
- [Автоматическое дифференцирование](#автоматическое-дифференцирование)
  - [Введение в глубокое обучение](#введение-в-глубокое-обучение)
    ...
    - [Ошибки и эмпирический риск](#ошибки-и-эмпирический-риск)
      - [Эмпирический риск $-$ дифференциируемый](#эмпирический-риск---дифференциируемый)
  ...
  - [Автоматическое дифференциирование](#автоматическое-дифференциирование)
    - [Дифференцирование составных функций по графу вычислений](#дифференцирование-составных-функций-по-графу-вычислений)
      - [$\\to$ *Функции храним в виде графа вычислений.* (Граф направленный ацикличный)](#to-функции-храним-в-виде-графа-вычислений-граф-направленный-ацикличный)
      - [Имеем два типа дифференцирования: прямое и обратное](#имеем-два-типа-дифференцирования-прямое-и-обратное)
      - [Пересчет производной](#пересчет-производной)
      - [Совмещение блоков и цепное правило](#совмещение-блоков-и-цепное-правило)
      - [Алгоритм дифференцирования по графу вычислений](#алгоритм-дифференцирования-по-графу-вычислений)
