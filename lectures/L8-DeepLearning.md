...
Признаки в теории можно не трогать, а можно усложнять функцию. То есть функцию $sign(\lang x, \theta\rang + \theta_0$ можно представить как знак скалярного произведения и проверить с какой стороны от гиперплоскости расположена точка.
