...
Рассмотрим линейную классификацию на двух признаках $\text{sign}(\lang x, \theta \rang + \theta_0)$, третий признак -- класс. Здесь у нас задача разделения на 2 класса точек, которые были получены из функции, которую можно задать как логическое или или исключающее или. 
