...
* Медленный
* Умеет собирать кластеры в разные формы
...
2) **Достижимость**: p ***достижима*** из q, если $\exist{a_i}$, где $a_i$ ***непосредственно достижима*** из $a_{i-1}$
...
3) **Связные точки**: точка B ***связна*** с точкой C, если $\exist A$, что точки C и B ***достижимы*** из точки A. 
